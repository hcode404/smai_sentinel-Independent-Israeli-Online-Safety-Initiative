...
route('/account',async app=>{
 ...
 const u=Auth.user,prefs={...mailPrefDefaults(),...(u.mailPrefs||{})},privacy={dmFrom:'all',friendRequests:'all',profileVis:'public',onlineStatus:'friends',showFollowers:true,showVerified:true,readReceipts:true,...(u.privacy||{})};
